...
def process_song_data(spark, input_data, output_data):
    #This function process the song_data by extracting songs table and artist table.
...
def process_log_data(spark, input_data, output_data):
     #This function process the log_data by extracting users table ,time table and songplays table.
    ...
    time_table = time_table = df.withColumn("hour",hour("start_time"))\
